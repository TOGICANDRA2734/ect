    ...
    function createRows(response) {
        ...
        if (len > 0) {
            for (var i = 0; i < len; i++) {
                ...
                // Foto Pengguna
                img_modal = "<img class='h-36 mr-3' src='https://192.168.20.100/manpower/" + response['data'][0].foto1 + "' alt='Foto 1'>" +
                    "<img class='h-36 mr-3' src='https://192.168.20.100/manpower/" + response['data'][0].foto2 + "' alt='Foto 2'>" +
                    "<img class='h-36 mr-3' src='https://192.168.20.100/manpower/" + response['data'][0].ktp + "' alt='Foto KTP'>";
                ...
                dokumen_modal =
                    ...
                    "<a href='https://192.168.20.100/manpower/" + response['dataDokumen'][0].link + "'  target='_blank' class='bg-stone-800 p-1.5 text-white rounded-md font-bold uppercase'>Buka</a>" +
                    "</td>" +
                    "</tr>";
